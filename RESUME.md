...
I have had the privilege of working at the Pentagon as a cyber security expert and have provided assistance to numerous large organizations in the United States, ranging from large educational institutions to the Department of Defense (DoD) and Office of Secretary of Defense (OSD) IT security systems. My focus has always been on developing, maintaining, and reinforcing IT security systems to the highest standards, leveraging my background in software development and utilizing industry Tactics, and Procedures (TTP) research and development for behavioral model development.
...
**Cyber Security Consulting, Accenture Federal Services**  
**Cyber Security Architect/Delivery Manager**  
          **JUNE 2024 \- CURRENT**  
Conducted detailed security reviews of architectural diagrams with project teams, identifying and recommending remediations for potential risks, ensuring compliance with security frameworks and best practices. Proactively reviewed existing security policies, identifying gaps and recommending specific technical solutions to improve overall security posture.  
Performed comprehensive policy assessments, resulting in the development of detailed recommendations for technical implementation and security optimization. **Focus is Cloud and AI applications.** 

* Worked as part of the Security Engineering, Architecture, and Risk Team operating as a senior technical resource for the CISO office.   
* Developed Custom tooling around RAG and AI productivity. **Prompt engineering**.   
* Personally conducted a company wide risk assessment, and focused on new technical projects representing the CISO office.  
* Cybersecurity technical resource for the Policy and Standards team.    
* Worked as part of the NIST 800-218 process to better secure the development process.   
* Provided technical solutions for the NIST 800-171 reviews.   
* Engaged in CMMC audit activities. 

**Cyber Security Special Operations Consulting, AMSYS**  
**Director of CyberSecurity Special Operations / Security Architect**  
          **MAR 2022 \- JUNE 2024**  
...
Played a key role in developing and implementing a red team strategy and operational framework. Supported the development of red team methodologies, tools, and training programs. Collaborated on the design and execution of red team exercises and Special Operations.

* Designed and Coded Custom Security solution for 24/7 external attack surface monitoring.   
* Coded API pushes and pulls to get custom data streams like firewall notifications into the SIEM.   
* Reviewed and monitored Darktrace configuration and recommended custom ML modeling.   
* Monitored the Crowdstrike Incidents and Detections using a custom dashboard for intelligent filtering of the alerts.   
* Consulted as a Tier 3 operator for C-Level Cybersecurity concerns. 

**Security Architect Consulting, AMSYS**  
**Director of Information Security / Security Architect**  
           **FEB 2020 \- MAR 2022**

As a Security Program Manager for AMSYS and its clients, my responsibilities have included providing expert guidance on security architecture, and implementing and managing Security Orchestration via APIs to ElasticSearch. Additionally, I have designed and built reporting dashboards for threat hunting, investigations, and status reports.
...
**Security Engineer \- Short term contract	                 	OCT 2018 \- FEB 2019** 
...
**Ellucian (Formerly Data-tel and SungardHE)**  
...
**Brandon Technology Consulting, MHS/TMA (TRICARE)        		Senior Information Assurance Engineer				SEP 2011 – JAN 2012**   
...
**Lockheed Martin IS\&GS, US Air Force  **                                  
...
**US Army, 3-159 Attack Recon Batt. 12th cab Task Force 34: DEPLOYED                                               2008 – 2009 (Retired from service for injuries, Service dates OCT 2006 \- MAR 2010\)**  
...
●    Provided near 100% uptime to critical users.
...
**Technical Proficiencies (Keywords):**  
**\-** **Operating Systems**: Microsoft Windows, Unix/Linux (Red Hat, Fedora, Ubuntu, SUSE Solaris)  
...
**\- Tools**: Remedy, Retina, metasploit, Hercules, ngrep, Wireshark, nmap, Nessus, nexpose, Netcat, Kismet, GFI Languard, Citrix, AppDetective, Web Inspect, OpenVAS, Greenbone and many other Open-Source tools. Darktrace, Splunk, InsightIDR, InsightVM, Crowdstrike and may more.  
\-**Scripting:** PHP, Perl, Ruby, WSH, Bash, VB, Java, Python, C (IoT)  
\-**Threat Modelling:** STRIDE, PASTA, TRIKE, ATTACK TREE, DREAD, KILL CHAIN, CAPEC  
